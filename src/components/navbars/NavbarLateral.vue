...
<!-- Bottons Rotas arrumar para ficar igual a deles -->
<template id="Nav_lat">
      <div class="col-12">
            <ul class="list-group nav_lateral">
                  <!-- Dashboard -->
                  <li :class="['navbar_itens', {'item_nav_act' :item_ativo === 'dashboard'}]">
                        <button  class="btn item_nav col-12" @click="changePage('dashboard')">
                              <span>
                  ...
                  <!-- Empresas -->
                  <li :class="['navbar_itens', {'item_nav_act' :item_ativo === 'empresas'}]">
                        <button class="btn item_nav col-12" @click="changePage('empresas')">
                              <span>
                  ...
                  <!-- Canais -->
                  <li :class="['navbar_itens', {'item_nav_act' :item_ativo === 'canais'}]">
                        <button class="btn item_nav col-12" @click="changePage('canais')">
                              <span>
                  ...
                  <li class="navbar_itens">
                        ...
                        <ul class="list-group">
                              ...
                              <li :class="['navbar_itens', {'item_nav_act' :item_ativo === 'map_pro'}]">
                                    <button class="btn item_nav col-12" @click="changePage('mapeamentoprodutos')">
                                          <span>
