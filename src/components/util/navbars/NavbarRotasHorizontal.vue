...
<template id="Nav_lat">
      <div class="my-2">
            <span class="text">TekHub Integrações</span>
            ...
            <span id="icon_open">
                  ...
                  <span></span>
                  <span></span>
                  <ul class="list-group nav_lateral" id="menu">
                        <!-- Dashboard -->
                        ...
                        <li class="navbar_itens" @click="integracaoIsactive = !integracaoIsactive">
                              ...
                              <ul :class="['list-group item_nav_interno']">
...
.text{
      ...
      left: 70px;
      top : 8px;
      font-size: 1.5em; color: var(--bs-white);
}
.nav_lateral{
...
#icon_open span:first-child{
  transform-origin: 0% 0%;
}
#icon_open span:nth-last-child(2){
  transform-origin: 0% 100%;
}
#icon_open input:checked ~ span{
  opacity: 1;
  transform: rotate(45deg) translate(-3px, -1px);
  background: var(--bs-danger)
}
#icon_open input:checked ~ span:nth-last-child(3){
  opacity: 0;
  transform: rotate(0deg) scale(0.2, 0.2);
}

#icon_open input:checked ~ span:nth-last-child(2){
